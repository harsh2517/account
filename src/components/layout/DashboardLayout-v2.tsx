...
const UserHeader = () => {
    ...
    return (
      <div className="w-full h-auto text-center font-semibold text-base py-2 flex flex-col items-center justify-center gap-1">
        ...
        { isOwner &&
          <Link className="flex items-center gap-2 w-full p-2 text-sm font-normal h-8 hover:bg-sidebar-accent rounded-md"  href="/members">
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button className="flex items-center gap-2 w-full p-2 text-sm font-normal h-8 hover:bg-sidebar-accent rounded-md">
