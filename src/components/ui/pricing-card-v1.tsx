  ...
  return (
    <div id="pricing" className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50/30 to-slate-100 flex items-center justify-center p-4 pt-8">
      <div className="flex flex-col lg:flex-row gap-8 w-full max-w-6xl items-center justify-center">
        ...
        {/* Free Plan Card */}
        <div className="relative flex-1 min-w-[320px] max-w-[700px]">
          ...
          <div
            className="relative p-[3px] rounded-3xl overflow-hidden transition-all duration-500 hover:scale-[1.02]"
