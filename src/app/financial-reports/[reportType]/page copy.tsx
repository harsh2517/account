...
const MAX_DATE_RANGE_DAYS = 1096; // Increased to 3 years

const getPeriods = (start: Date, end: Date, format: "monthly" | "quarterly"): Period[] => {
        ...
        <ScrollArea className="w-full whitespace-nowrap">
            {!isLoading && actualReportData && (
                ...
                <CardHeader>
                    ...
                    {companyName && <CardDescription>{companyName}</CardDescription>}
                </CardHeader>
                <CardContent>
