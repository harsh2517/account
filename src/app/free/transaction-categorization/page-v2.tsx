...
import { Landmark, ArrowLeft, Upload, Trash2, FileDown, Edit3, AlertTriangle, ArrowUp, ArrowDown, Search, Sparkles, SearchCheck, Library, PlusCircle, Info, Download } from "lucide-react";
  ...
  const handleAiCategorizeTransactions = async () => {
    ...
    try {
      ...
      if (transactionsEligibleForAICategorization.length === 0) {
        toast({ title: "AI Categorization", description: "No transactions currently require AI categorization (e.g., those with empty vendor & GL, or marked 'Ask My Accountant').", variant: "default" });
