    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      if (email && apiKey) {
        ...
        if (validationResult.isValid) {
          ...
          // Store email in Firebase for marketing (fire and forget)
          try {
            await addDoc(collection(db, "freeToolUsers"), {
              email: email,
              signupDate: serverTimestamp(),
            });
          } catch (error) {
            console.error("Error storing marketing email:", error);
          }
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-50 rounded-lg border border-gray-200 shadow-sm p-6">
            ...
            <ol className="list-decimal list-inside space-y-3 text-gray-700">
              ...
              <li>Copy & paste to start using the tools</li>
            </ol>
